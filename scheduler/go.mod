module github.com/liamzebedee/goliath/scheduler-executer
...
require (
	...
	github.com/liamzebedee/goliath-blockchain/sequencer/mvp v0.0.0-20220623034338-ec5ff6da4e05 // indirect
